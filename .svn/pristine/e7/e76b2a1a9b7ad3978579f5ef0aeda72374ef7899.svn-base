  ...
  <div class="app-container">
    <div class="top_search">
      ...
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="110px">
        <el-form-item label="电站名称" prop="postCode">
          <el-select v-model="queryParams.status" placeholder="请选择电站" clearable size="small">
            <el-option v-for="dict in statusOptions1" :key="dict.dictValue" :label="dict.dictLabel"
              :value="dict.dictValue" />
          </el-select>
        </el-form-item>
        <el-form-item label="设备名称" prop="postName">
          <el-input v-model="queryParams.status" placeholder="请输入设备名称" clearable size="small">
        ...
        <el-form-item label="设备型号" prop="postCode">
          <el-input v-model="queryParams.postName" placeholder="请输入设备型号" clearable size="small" />
        </el-form-item>
        <br>
        <el-form-item label="告警级别" prop="postCode">
          <el-select v-model="queryParams.status" placeholder="请选择告警级别" clearable size="small">
            <el-option v-for="dict in statusOptions1" :key="dict.dictValue" :label="dict.dictLabel"
              :value="dict.dictValue" />
          </el-select>
        </el-form-item>
        <el-form-item label="告警类型" prop="postCode">
          <el-select v-model="queryParams.status" placeholder="请选择告警类别" clearable size="small">
            <el-option v-for="dict in statusOptions1" :key="dict.dictValue" :label="dict.dictLabel"
              :value="dict.dictValue" />
          </el-select>
        </el-form-item>
        <el-form-item label="告警来源" prop="postCode">
          <el-select v-model="queryParams.status" placeholder="请选择告警来源" clearable size="small">
            <el-option v-for="dict in statusOptions1" :key="dict.dictValue" :label="dict.dictLabel"
              :value="dict.dictValue" />
          </el-select>
        </el-form-item>
        <el-form-item label="告警状态" prop="postCode">
    ...
    <div class="middle_table">
      ...
      <el-table v-loading="loading" :row-class-name="tableRowClassName" :data="powerList"
        ...
        <el-table-column label="告警来源" align="center" prop="source" />
        ...
        <el-table-column label="发生时间" align="center" prop="occurrence" />
        <el-table-column label="回复时间" align="center" prop="answer" />
    ...
    data() {
      return {
        ...
        powerList: [{
            ...
            state:'未处理',
            type:'自动告警',
            occurrence:'2021-08-30 06:40:00.0',
            answer:'',
            sendState:'已发送'
          }, {
            powstation: '聂家村',
            ...
            state:'完成',
            type:'自动告警',
            occurrence:'2021-08-30 06:15:00.0',
            answer:'2021908030 06:40:27.0',
            sendState:'已发送'
          }, {
            powstation: '小吴',
            status: '天桥',
            ...
            state:'未处理',
            type:'自动告警',
            occurrence:'2021-08-30 06:10:00.0',
            answer:'',
            sendState:'已发送'
          }, {
            powstation: '讲书院村',
            ...
            state:'未处理',
            type:'自动告警',
            occurrence:'2021-08-30 06:05:00.0',
            answer:'',
            sendState:'已发送'
          }
        ],

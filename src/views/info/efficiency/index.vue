  ...
  <div class="app-container">
    <div class="top_search">
      ...
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="110px">
        ...
        <el-form-item label="逆变器名称" prop="postName">
    ...
    <div class="middle_table">
      <div class="table_btn">
        ...
        <div>
          <el-button type="primary" plain size="mini">瞬时信息</el-button>
      ...
      <el-table v-loading="loading" :row-class-name="tableRowClassName" :data="powerList"
        ...
        <el-table-column label="所属电站" align="center" prop="status" sortable />
        <el-table-column label="所属乡镇" align="center" prop="capacity" sortable />
        <el-table-column label="所属区县" align="center" prop="daypower" sortable />
        <el-table-column label="逆变效率(%)" align="center" prop="monthpower" sortable />
      </el-table>

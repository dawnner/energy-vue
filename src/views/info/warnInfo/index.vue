  ...
  <div class="app-container">
    <div class="top_search">
      ...
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="110px">
        ...
        <el-form-item label="开始时间" prop="postName">
          <el-date-picker v-model="queryParams.date1" type="datetime" placeholder="选择开始时间" size="small">
          </el-date-picker>
        </el-form-item>
    ...
    <div class="middle_table">
      ...
      <el-table v-loading="loading" :row-class-name="tableRowClassName" :data="powerList"
        ...
        <el-table-column label="乡镇名称" align="center" prop="status" />
        <el-table-column label="区县名称" align="center" prop="capacity" />
        <el-table-column label="外网告警数量" width="125" align="center" prop="daypower" sortable />
        <el-table-column label="电站告警数量" width="125" align="center" prop="monthpower" sortable />
        <el-table-column label="一般告警数量" width="125" align="center" prop="sumpower" sortable />
        <el-table-column label="告警总数" align="center" prop="days" sortable>
        </el-table-column>
      </el-table>
